...
def test_06():
    # 192.168.1.0/30 2 2 100.00%

    generate_range("192.168.1.0", "192.168.1.3")

def test_07():
    # 192.168.0.0/22 1022 130 12.720%
    # 192.168.1.0/24 254 130 51.18%
    # 172.16.32.0/24 254 130 51.18%

    generate_range("172.16.32.1", "172.16.32.130")
    generate_range("192.168.1.1", "192.168.1.130")
